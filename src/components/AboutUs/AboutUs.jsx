    ...
    return(
        <section>
            ...
            <article>
                ...
                <img src={family} className="aboutUsImg" alt="Familia" />
            ...
            <article>
                ...
                <img src={premium} className="aboutUsImg" alt="Calidad" />
            ...
            <article>
                ...
                <img src={trust} className="aboutUsImg" alt="Confianza" />
            ...
            <article>
                ...
                <img src={local} className="aboutUsImg" alt="Local" />
            ...
            <article>
                ...
                <img src={science} className="aboutUsImg" alt="Tecnología" />
            ...
            <article>
                ...
                <img src={sustentable} className="aboutUsImg" alt="Sustentabilidad" />
